...
public class NoteController {
    ...
    public void returnOrder(@RequestBody NotesDto noteDto){
     ...
     public NotesDto getNoteByOrderId(@PathVariable Integer orderId){
         return noteService.getNoteByOrderId(orderId);
    }
    @DeleteMapping("/delete/{orderId}")
    public void deleteNoteByOrderId(@PathVariable Integer orderId){
        noteService.deleteNoteByOrderId(orderId);
    }
    @PutMapping("/return/{orderId}/{returnQuantity}")
    public void updateReturnOrderById(@PathVariable Integer orderId, @PathVariable Integer returnQuantity){
        noteService.updateReturnOrderById(orderId, returnQuantity);
    }
